  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="{{ url('addPurchase') }}">Tambah Pembelian</a></li>
      ...
      <div class="box">
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            ...
            <div id="container_jatuh_tempo" style="display: none;" class="form-group">
        ...
        <div class="box-body">
          <div class="table-responsive">
            ...
            <div class="col-md-2">
                ...
                <button onclick="simpanPembelian()" class="btn btn-sm btn-primary form-control"><i class="fa fa-save"></i> Simpan</button>
...
<script type="text/javascript">
          ...
          function simpanPembelian(){
            ...
            if(popup==true){
                ...
                $.ajax({
                    url : "{{ url('simpan_purchase') }}",
                    type : "POST",
                    data : {'supplier':supplier, 'deskripsi':deskripsi, 'dp':dp, 'tipe_pembayaran':tipe_pembayaran, 'jatuh_tempo':jatuh_tempo, 'total':total, '_token':csrf_token },
                    success:function(data){
