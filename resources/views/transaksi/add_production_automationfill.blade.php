        ...
        <section class="content">
            ...
            <div class="box">
                <div class="box-header with-border" style="background-color: whitesmoke">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Grade</label>
                                <input type="text" class="form-control" id="grade" name="grade" value="{{ $good->grade }}" readonly>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Colour</label>
                                <input type="text" class="form-control" id="colour" name="colour" value="{{ $good->colour }}" readonly>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                ...
                <div class="box-header with-border" style="background-color: #FFEBCD">
                    {{-- <div class="row">
                        <div class="col-md-12">
                            <button onclick="addItem()" id="tambah_item" class="btn btn-sm btn-default pull-left"><i
                                    class="fa fa-plus"></i> Item</button>
                        </div>
                    </div> --}}
                    <div style="margin-bottom: 10px"></div>
                    <div class="row" id="ruang_tambah">
                        <div class="col-md-3">

                            <select class="form-control" id="barang" name="barang" disabled>
                                <option value=""> -Pilih Barang- </option>
                                @foreach ($barang as $row)
                                    <option value="{{ $row->id }}" @if($row->id == $good->id) selected @endif>{{ $row->good_name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-2">
                            <input id="satuan" type="text" class="form-control bulat" placeholder="Satuan" value="{{ $good->unit }}"
                                readonly="readonly">
                        </div>
                        <div class="col-md-2">
                            <input id="total" type="number" class="form-control bulat" placeholder="Total"
                                readonly="readonly">
                        </div>
                        <div class="col-md-1">
                ...
                <div class="box-body">
                    <div class="table-responsive">
                        ...
                        <div class="col-md-2">
                            ...
                            <button onclick="simpanProduksi()" class="btn btn-sm btn-primary form-control"><i
                                    class="fa fa-save"></i> Simpan</button>
                            <div style="margin-top: 3px"></div>
                            <button onclick="batalProduksi()" class="btn btn-sm btn-warning form-control"><i
                                    class="fa fa-remove"></i> Batal</button>
                        </div>
                        <div class="col-md-12">
                            <a href="{{ url('production') }}"><button class="btn btn-sm btn-info"><i
                        ...
                        <form id="form-purchase" data-toggle="validator">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" id="quantity_modal" name="quantity" class="form-control"
                                        required>
                                    <span class="help-block with-errors"></span>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" id="item_price_modal" name="item_price" class="form-control"
                                        required>
                                    <span class="help-block with-errors"></span>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" id="item_total_modal" name="item_total" class="form-control"
                                        readonly>
                                    <span class="help-block with-errors"></span>
                        ...
                        if (barang == '') {
                            ...
                            $.ajax({
                                ...
                                success: function(data) {
                                    ...
                                    var title = data.barang + ' (' + data.qty_order + ' ' + data
                                        .satuan + ')';
