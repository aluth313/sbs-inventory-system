      ...
      <div class="box">
          <div class="box-header with-border">
              <div class="row">
                  <div class="col-md-4">
                      <label>Teknisi</label>
                      <input type="text" class="form-control" readonly value="{{$service->nama}}">
                  </div>
                  <div class="col-md-4">
                      <label>Catatan</label>
                      <input type="text" class="form-control" readonly value="{{$service->note}}">
                  </div>
                  <div class="col-md-4">
                      <label>Invoice</label>
                      <input type="text" id="inv-no" class="form-control" readonly value="{{$service->invoice}}">
                  </div>
              </div>
                            ...
                            <table class="table table-striped">
                                <thead>
                                    <tr>
                                       ...
                                       <td width="1%">:</td>
                                       <td width="*"><input type="text" id="tanda-terima" readonly class="form-control" value="{{ $tt->ttno }}"></td>
                                    </tr>
                                    
                                    <tr>
                                       <td width="30%">Nama Pelanggan</td>
                                       <td width="1%">:</td>
                                       <td width="*"><input type="text" id="pelanggan" value="{{$tt->customer_name}}" readonly class="form-control"></td>
                                    </tr>
                                    <input type="hidden" id="id-pelanggan" value="{{$tt->customer_id}}">
                                    <tr>
                                       <td width="30%">Alamat Pelanggan</td>
                                       <td width="1%">:</td>
                                       <td width="*"><textarea style="height: 70px" readonly id="alamat-pelanggan" class="form-control">{{$tt->customer_address}}</textarea></td>
                                    </tr>
                                    <tr>
                                       <td width="30%">Nama Item</td>
                                       <td width="1%">:</td>
                                       <td width="*"><input type="text" id="nama-item" readonly class="form-control" value="{{$tt->item_name}}"></td>
                                    </tr>
                                    <tr>
                                       <td width="30%">Tipe/SN</td>
                                       <td width="1%">:</td>
                                       <td width="*"><input type="text" id="tipe" readonly class="form-control" value="{{$tt->tipe}}"></td>
                                    </tr>
                                    <tr>
                                       <td width="30%">Keterangan</td>
                                       <td width="1%">:</td>
                                       <td width="*"><textarea style="height: 70px" readonly id="keterangan" class="form-control">{{$tt->keterangan}}</textarea></td>
                                    </tr>
                                    <tr>
                                       <td width="30%">Keluhan</td>
                                       <td width="1%">:</td>
                                       <td width="*"><textarea style="height: 70px" readonly id="keluhan" class="form-control">{{$tt->keluhan}}</textarea></td>
                                    </tr>
                                    <tr>
                                       <td width="30%">Kelengkapan</td>
                                       <td width="1%">:</td>
                                       <td width="*"><textarea style="height: 70px" readonly id="kelengkapan" class="form-control">{{$tt->kelengkapan}}</textarea></td>
                                    </tr>
                                    <tr>
                                       <td width="30%">Tgl Selesai</td>
                                       <td width="1%">:</td>
                                       <td width="*"><input type="text" id="tgl-selesai" readonly class="form-control" value="{{$tt->estimasi_selesai}} Hari"></td>
                                    </tr>
                                </thead>
                            </table>
                        </div>
                      ...
                      <div class="row">
                          <div class="col-md-12">
                              <div class="modal-body">
                                  ...
                                  <div class="form-group">
                                      <label>Harga</label>
                                      <input type="number" id="price_barang" name="price_barang" class="form-control" required readonly>
                                      <span class="help-block with-errors"></span>
                                  </div>
                                  <div class="form-group">
                                      <label>Total</label>
                          ...
                          <div class="col-md-12">
                              <div class="modal-body">
                                  <div class="form-group">
                                    ...
                                    <input type="date" id="trans_date" class="form-control" value="{{ date('Y-m-d', strtotime($service->created_at)) }}">
                                  </div>
                                  <div class="form-group">
                                      ...
                                      <select id="tech_name" name="tech_name" class="form-control" required>
                                          ...
                                          @foreach($tech as $key)
                                              <option value="{{$key->id}}" <?php if ($key->id == $service->tech_id) echo 'selected';?>>{{$key->nama}}</option>
                                          @endforeach
                                      </select>
                                      <span class="help-block with-errors"></span>
                                  </div>
                                  <div class="form-group">
                                    ...
                                    <input type="text" id="fak-no" value="{{$service->fak_no}}" class="form-control">
                                  </div>
                                  <div class="form-group">
                                    <label>DO No:</label>
                                    <input type="text" id="do-no" value="{{$service->do_no}}" class="form-control">
                                  </div>
                                  <div class="form-group">
                                    <label>PO No:</label>
                                    <input type="text" id="po-no" value="{{$service->po_no}}" class="form-control">
                                  </div>

                                  <div class="form-group">
                                      <label>Keterangan:</label>
                                      <textarea class="form-control" id="ket-teknisi" name="ket-teknisi" style="height: 90px">{{$service->note}}</textarea>
                                  </div>
  ...
  <script type="text/javascript">
          ...
          $('#modal-teknisi form').submit(function(e){
              ...
              $.ajax({
                  ...
                  type    : "POST",
                  data    : {tgl_trans:tgl_trans, invoice:invoice, teknisi:teknisi, ttno:ttno, cust:cust, ket:ket, fakno:fakno, dono:dono, pono:pono, total:total,  _token:_token},
                  success : function(data){
                      alert("Service Diupdate....");
