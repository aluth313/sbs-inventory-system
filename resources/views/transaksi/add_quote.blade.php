  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="{{ url('addQuote') }}">Tambah Quotation</a></li>
      ...
      <div class="box">
        ...
        <div class="row">
          <div class="col-md-3">
            ...
            <div class="form-group">
              <input type="text" class="form-control" id="attn" name="attn" placeholder="Attn" required>
            </div>
            <div class="form-group">
              <input type="text" class="form-control" id="dari" name="dari" placeholder="From" required>
            </div>
          </div>
          <div class="col-md-3">
              <div class="form-group">
          ...
          <div class="col-md-2">
              <div class="form-group">
                <input type="text" id="ref" name="ref" class="form-control" placeholder="Our Reff">
              </div>
              <div class="form-group">
                <input type="text" id="ref2" name="ref2" class="form-control" placeholder="Your Reff">
              </div>
          </div>
          ...
          function simpanPenawaran(){
              ...
              if(popup==true){
                  ...
                  if(customer=='') alert('Customer Belum Dipilih...!');
                      ...
                      $.ajax({
                          url  : "{{ url('simpan_transaksi_quote') }}",
                          type : "POST",
                          data : {customer:customer, attn:attn, email:email, fax:fax, dari:dari, ref:ref, ref2:ref2, tanggal:tanggal, total:total, _token:csrf_token },
                          success:function(data){
