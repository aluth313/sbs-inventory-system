...
<?php $dataCustomer = isset($_POST['customer_id']) ? $_POST['customer_id'] : $sales->cust_id;?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="javascript:void(0)">Edit Penjualan</a></li>
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="row">
          <div class="col-md-12">
              <h3><u>Invoice : {{$invoice}}</u></h3>
              <input type="hidden" id="sales_invoice" value="{{$invoice}}">  
          </div>
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="form-group">
              ...
              <input type="date" class="form-control bulat" id="trans_date" value="{{ date('Y-m-d',strtotime($sales->created_at))}}">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <select id="tipe_pembayaran" class="form-control">
                ...
                <option value = "1" <?php if ($sales->tipe == "1") echo 'selected';?>>Cash</option>
                <option value = "2" <?php if ($sales->tipe == "2") echo 'selected';?>>Credit</option>
              </select>
            </div>
          ...
          <div class="col-md-4">
            <div class="form-group">
              <label>DP</label>
              <input type="number" class="form-control" id="dp" value="{{$sales->dp}}">
            </div>
            <?php 
              if($sales->tipe ==1){
            ...
            <div id="container_jatuh_tempo" {{$style}} class="form-group">
              ...
              <select id="jatuh_tempo" class="form-control">
                 ...
                 <option value = "1" <?php if ($sales->due == "1") echo 'selected';?>>1 HARI</option>
                 <option value = "7" <?php if ($sales->due == "7") echo 'selected';?>>7 HARI</option>
                 <option value = "14" <?php if ($sales->due == "14") echo 'selected';?>>14 HARI</option>
                 <option value = "28" <?php if ($sales->due == "28") echo 'selected';?>>28 HARI</option>
                 <option value = "30" <?php if ($sales->due == "30") echo 'selected';?>>30 HARI</option>
                 <option value = "45" <?php if ($sales->due == "45") echo 'selected';?>>45 HARI</option>
                 <option value = "60" <?php if ($sales->due == "60") echo 'selected';?>>60 HARI</option>
                 <option value = "75" <?php if ($sales->due == "75") echo 'selected';?>>75 HARI</option>
                 <option value = "90" <?php if ($sales->due == "90") echo 'selected';?>>90 HARI</option>
              </select>
            </div>
            
            <div class="form-group">
              <label>Deskripsi</label>
              <textarea id="description" name="description" class="form-control" required style="height: 60px;border-radius: 3px;">{{$sales->note}}</textarea>
            </div>
          </div>
          <div class="col-md-4">
...
<script type="text/javascript">
          ...
          function simpanPenjualan(){
            ...
            if(popup==true){
                ...
                $.ajax({
                    url  : "{{ url('update_transaksi_sales') }}",
                    type : "POST",
                    data : {tgl_trans:tgl_trans, invoice:invoice, customer:customer, deskripsi:deskripsi, dp:dp, tipe_pembayaran:tipe_pembayaran, jatuh_tempo:jatuh_tempo, total:total, _token:csrf_token },
                    success:function(data){
                          alert('Penjualan Diupdate...');
                          reloadTable();
                          clearForm()
