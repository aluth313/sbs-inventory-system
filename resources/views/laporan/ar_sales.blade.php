...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="javascript:void(0);">Laporan Piutang Penjualan</a></li>
  ...
  <script type="text/javascript">
    ...
    function cetakLaporan(){
       ...
       $.ajax({
            url : "{{ url('arsales_cetak_sekarang')}}"+"/"+customer,
            type : "GET",
            success : function(data){
              $('#btn_cetak').removeAttr("disabled");
              $('#loadingProgress').hide();
              window.open("{{ url('arsales_cetak_sekarang')}}"+"/"+customer, "Laporan Piutang Penjualan", "height=900, width=1000, scrollbars=yes");
            },
            error: function(){
              $('#loadingProgress').hide();
