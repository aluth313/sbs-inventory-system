  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="javascript:void(0);">Laporan Service</a></li>
  ...
  <script type="text/javascript">
    ...
    function cetakLaporan(){
        ...
        else
        {
           ...
           $.ajax({
              url : "{{ url('servcetak')}}"+"/"+dari+"/"+sampai,
              type : "GET",
              success : function(data){
                $('#btn_cetak').removeAttr("disabled");
                $('#loadingProgress').hide();
                window.open("{{ url('servcetak')}}"+"/"+dari+"/"+sampai, "Laporan Servie", "height=900, width=1000, scrollbars=yes");
              },
              error: function(){
                $('#loadingProgress').hide();
