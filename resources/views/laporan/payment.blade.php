...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="javascript:void(0);">Laporan Pembayaran Supplier</a></li>
              ...
              <div class="col-md-4">              
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <select id="cmb-supplier" class="form-control">
  ...
  <script type="text/javascript">
    ...
    function cetakLaporan(){
      ...
      var supplier = $('#cmb-supplier').val(); 
      $('#btn_cetak').attr("disabled",true);
      $('#loadingProgress').show();
      $.ajax({
          url : "{{ url('pembayaran_cetak_sekarang')}}"+"/"+supplier,
          type : "GET",
          success : function(data){
            $('#btn_cetak').removeAttr("disabled");
            $('#loadingProgress').hide();
            window.open("{{ url('pembayaran_cetak_sekarang')}}"+"/"+supplier, "Laporan Pembayaran Supplier", "height=900, width=1000, scrollbars=yes");
          },
          error: function(){
            $('#loadingProgress').hide();
