  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="javascript:void(0);">Laporan Komisi</a></li>
  ...
  <script type="text/javascript">
    ...
    function cetakLaporan(){
        ...
        else
        {
           ...
           $.ajax({
              url : "{{ url('komcetak')}}"+"/"+dari+"/"+sampai,
              type : "GET",
              data : {teknisi:teknisi},
              success : function(data){
                $('#btn_cetak').removeAttr("disabled");
                $('#loadingProgress').hide();
                window.open("{{ url('komcetak')}}"+"/"+dari+"/"+sampai, "Laporan Komisi", "height=900, width=1000, scrollbars=yes");
              },
              error: function(){
                $('#loadingProgress').hide();
                $('#btn_cetak').removeAttr("disabled");
