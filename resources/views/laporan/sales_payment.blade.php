...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="javascript:void(0);">Laporan Pembayaran Penjualan</a></li>
  ...
  <script type="text/javascript">
    ...
    function cetakLaporan(){
       ...
       $.ajax({
            url : "{{ url('pembayaran_sales')}}"+"/"+customer,
            type : "GET",
            success : function(data){
              $('#btn_cetak').removeAttr("disabled");
              $('#loadingProgress').hide();
              window.open("{{ url('pembayaran_sales')}}"+"/"+customer, "Laporan Pembayaran Service", "height=900, width=1000, scrollbars=yes");
            },
            error: function(){
              $('#loadingProgress').hide();
