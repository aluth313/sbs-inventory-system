...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Laporan Pembayaran Service
        <small></small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="{{ url('dashboard') }}"><i class="fa fa-dashboard"></i> Dashboard</a></li>
        <li><a href="javascript:void(0);">Laporan Pembayaran Service</a></li>
  ...
  <script type="text/javascript">
    ...
    function cetakLaporan(){
       ...
       $.ajax({
            url : "{{ url('pembayaran_service')}}"+"/"+customer,
            type : "GET",
            success : function(data){
              $('#btn_cetak').removeAttr("disabled");
              $('#loadingProgress').hide();
              window.open("{{ url('pembayaran_service')}}"+"/"+customer, "Laporan Pembayaran Service", "height=900, width=1000, scrollbars=yes");
            },
            error: function(){
              $('#loadingProgress').hide();
