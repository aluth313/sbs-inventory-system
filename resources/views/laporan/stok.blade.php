...
<!-- Content Wrapper. Contains page content -->
      ...
      <div class="box">
          ...
          <div class="box-body">
            ...
            <div class="row">
              ...
              <div class="col-md-12">
                <button onclick="cetakLaporan()" class="btn btn-default" id="btn_cetak"><i class="fa fa-print"></i> Cetak Stok</button>
              </div>
            </div>
          </div>
  ...
  <script type="text/javascript">
    ...
    function cetakLaporan(){
         ...
         $.ajax({
            url : "{{ url('stokcetak')}}"+"/"+kategori,
            type : "GET",
            success : function(data){
              $('#btn_cetak').removeAttr("disabled");
              $('#loadingProgress').hide();
              window.open("{{ url('stokcetak')}}"+"/"+kategori, "Laporan Stok", "height=900, width=1000, scrollbars=yes");
            },
            error: function(){
              $('#loadingProgress').hide();
